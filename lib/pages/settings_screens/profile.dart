...
class _ProfileState extends State<Profile> {
  ...
  Future<void> editField() async {
    ...
    builder: (context) => AlertDialog(
      title: Text('Edit your username', style: TextStyle(
      ...
      actions: [
        TextButton(
          onPressed: () {
            if (newVal.trim().isNotEmpty && newVal.trim().length < 16) {
              usersCollection.doc(user.email).update({'username': newVal});
          ...
          child: Text('Save',style: TextStyle(fontFamily: 'Cera Pro',color: Theme.of(context).colorScheme.secondary),)),
        TextButton(
          ...
          child: Center(
            child: Column(
              children: [
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      return const Center(child: CircularProgressIndicator());
                        ...
                        return Center(child: Text('No data found! ${snapshot.error}', style: TextStyle(
                          color: Theme.of(context).colorScheme.tertiary, fontFamily: 'Cera Pro', fontSize: 20)));
                      }
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('Name: ${userData!['username']}', style: TextStyle(
                                color: Theme.of(context).colorScheme.tertiary, fontFamily: 'Cera Pro', fontSize: 20)),
                ...
                const SizedBox(height: 20),
                const Center(child: Text('Your Posts',style: TextStyle(fontSize: 25,fontFamily: 'Cera Pro',fontWeight: FontWeight.bold),)),
                const SizedBox(height: 20),
                SizedBox(
                height: 600,
                child: StreamBuilder(
