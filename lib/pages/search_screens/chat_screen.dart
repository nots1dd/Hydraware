                  ...
                  child: ListView.builder(
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("${messages[index]}",style: TextStyle(fontFamily: 'Cera Pro',color: Theme.of(context).colorScheme.tertiary),textAlign: TextAlign.left,),
